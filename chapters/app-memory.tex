...
\begin{figure*}[]
  \includegraphics[scale=.75]{figs/exp1/cum_probs.pdf}
  \caption{%
...
\begin{figure*}[]
  \includegraphics[scale=.75]{figs/exp1_alt/rt.pdf}
...
\begin{figure*}[ht]
  \centering
  \includegraphics[scale=.75]{figs/exp2_alt/overall_timecourse.pdf}
...
\begin{figure*}[t]
  \includegraphics[scale=.75]{figs/exp2_alt/nonfinal.pdf}
...
\begin{figure*}[t]
  \includegraphics[scale=.75]{figs/exp2_alt/commitment.pdf}
...
\begin{figure*}[ht]
  \includegraphics[scale=.75]{figs/old_exp1/rt.pdf}
...
\begin{figure*}[ht]
  \centering
  \includegraphics[scale=.75]{figs/old_exp2/overall_timecourse.pdf}
...
\begin{figure*}[t]
  \includegraphics[scale=.75]{figs/old_exp2/nonfinal.pdf}
...
\begin{figure*}[t]
  \includegraphics[scale=.75]{figs/old_exp2/commitment.pdf}
