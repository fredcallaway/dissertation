...
\end{equation}
This is a slightly more precise version of the definition of optimal sequential models of resource-bounded congition given in Equation~\ref{eq:intro-master}.\footnote{%
...
\end{math}
%
where $f(a) = \expectunder{U(w, a)}{w \sim b_m}$. Note that the logic generalizes to the case where $\pi\act$ samples from the set of optimal actions.\todo{tallying?}
