...
% For a heuristic to be adaptive, it must only be effective in our ecology.
...
\colorlet{optimal}{SchoolColor}
\definecolor{ecology}{HTML}{4daf4a}
\definecolor{resource}{HTML}{377eb8}
\definecolor{info}{HTML}{7B2FB0}
\definecolor{sequential}{HTML}{D4609A}
\definecolor{cost}{HTML}{e41a1c}
