...
\begin{enumerate}
  ...
  %
  \specialitem{utility}{3} The utility of a mental action depends on its effect on behavior as well as its cost (Section~\ref{sec:intro-cost}).
  %
